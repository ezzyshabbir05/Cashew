...
String getChangelogString() {
  return """
    ...
    When tapping support, Penny Pro options highlight
    ...
    < 3.8.0
    Penny pro background now extends past scrollable area - support for (i) over-scroll
